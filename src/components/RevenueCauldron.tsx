...
const revenueData = [
  { label: "Today", value: "$2,847", trend: "+12%" },
  { label: "This Week", value: "$18,392", trend: "+8%" },
  { label: "This Month", value: "$67,241", trend: "+23%" },
];
    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <motion.div
          ...
          style={{
            background: "radial-gradient(circle, hsl(var(--glow-gold) / 0.15), transparent)",
          }}
        ...
        <div className="mt-5 flex items-end gap-1 h-12">
          {[35, 45, 30, 60, 50, 70, 55, 80, 65, 90, 75, 95].map((h, i) => (
            <motion.div
              ...
              style={{
                background: `linear-gradient(to top, hsl(var(--glow-gold) / 0.6), hsl(var(--glow-gold) / 0.15))`,
              }}
              initial={{ height: 0 }}
              animate={{ height: `${h}%` }}
